...
*/
    ...
    var body=document.querySelector("#root");
       ...
       // var name=document.createElement("h2");
        ...
        name1.textContent="Sarthika Danthuluri";
        console.log(name1);
        card1.appendChild(name1);
         // careate email
        var email=document.createElement("h4");
        email.textContent="dssarthika@gmail.com";
        card1.appendChild(email);

         // mobile number also
        var mobile=document.createElement("h4");
        mobile.textContent="8367070678";
        ...
        co1.textContent=" To work in an environment where I can utilize my skills and knowledge";
        div.appendChild(co1);
        ...
        s3.textContent="Web Desiging";
        div.appendChild(s3);

        var p=document.createElement("h4");
        p.textContent="Hobbies";
        div.appendChild(p);

        div.appendChild(document.createElement("hr"));

        var p1=document.createElement("p","pre");
        p1.textContent="Listening Music";
        div.appendChild(p1);

        var p2=document.createElement("p","pre");
        p2.textContent="Playing Badminton";
        div.appendChild(p2);

        var p3=document.createElement("p","pre");
        p3.textContent="Drawing";
        div.appendChild(p3);
        ...
        pp3.textContent="DOB          : 23/09/1999";
        div.appendChild(pp3);
